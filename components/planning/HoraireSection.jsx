...
export default function HoraireSection({ entrepriseId }) {
  ...
  function openEditForm(quart) {
    ...
    setForm({ employeId: quart.employe_id || "", heureDebut: quart.heure_debut.slice(0, 5), heureFin: quart.heure_fin.slice(0, 5) });
  }
  ...
  return (
    <div>
      <h2>Horaire</h2>
      <p className="panel-hint">Le planning de la semaine, par jour.</p>
      ...
      {loading ? (
        ...
        <p style={{ color: "var(--text-dim)" }}>
          Ajoute d'abord des employés dans l'onglet "Employés" pour pouvoir les placer dans l'horaire.
        </p>
      ) : (
