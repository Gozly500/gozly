...
export default function EmployesSection({ entrepriseId }) {
  ...
  return (
    <div>
      <h2>Employés</h2>
      <p className="panel-hint">Les personnes que tu peux placer dans l'horaire.</p>
      ...
      <form className="field-row" onSubmit={handleAdd} style={{ maxWidth: "500px", alignItems: "flex-end" }}>
        <div className="field">
          <label>Nom</label>
